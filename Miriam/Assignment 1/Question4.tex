...
This model is sound, because it is bounded and live.
...
This one is sound, because it is bounded and live. If you try every possible
trace you see that easily.
\subsection*{3.}
\begin{equation*}
...
It is not live, because it is never possible to fire a, so it is neither sound.